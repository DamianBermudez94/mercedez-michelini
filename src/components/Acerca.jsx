    ...
    return (
        <section className="bg-featured-properties-bg py-16">
            <div className="max-w-7xl mx-auto px-6">
                <h2 className="text-3xl md:text-5xl font-bold text-center text-card-text-color">Sobre Nosotros</h2>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-2 p-10'>
